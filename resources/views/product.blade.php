        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner min-vh-100">
                ...
                <div class="carousel-item {{$index ===1? 'active':''}}">
                    <img src="{{$item['product-image-url']}}" alt="" class="img-fluid rounded-circle" style="width:60%;">
                    <div class="container">
                        <div class="carousel-caption text-end">
                            <h1>{{$item['product-name']}}</h1>
                            <p>Some representative placeholder content for the third slide of this carousel.</p>
                            <p><a class="btn btn-lg btn-primary" href="#">{{$item['product-cta-text']}}</a></p>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container marketing">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-secondary" href="details/{{$item['id']}}">View details »</a></p>
                </div><!-- /.col-lg-4 -->
                @endforeach
            </div><!-- /.row -->
